...
Set-VMBios $VMName -StartupOrder @("IDE","LegacyNetworkAdapter","Floppy","CD")
Remove-VMNetworkAdapter -VMName $VMName 
Add-VMNetworkAdapter -VMName $VMName -SwitchName $Switch -IsLegacy 1
...
sudo crictl ps | wc -l
```
# Creation des VM Version image CD et pas PXE (Obsolete)
## Sur T30.  
```powershell
$VMName = 'P-OKD-BOOT-001'
